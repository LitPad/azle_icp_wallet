...
import { idlFactory } from './litpad_wallet.did.js';
export { idlFactory } from './litpad_wallet.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LITPAD_WALLET;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./litpad_wallet.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the litpad_wallet canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./litpad_wallet.did.js")._SERVICE>}
 */
export const litpad_wallet = createActor(canisterId);
